...
if __name__ == '__main__':
    ...
    print("===================================================")
    print("keyword origin: ",key)
    print("summarized:", summarize(text, ratio=0.2))
    print("===================================================")
    print("Keyword: ",get_keywords(text, ratio=0.1))

    '''url = "https://thanhnien.vn/dinh-chan-thuong-nang-haaland-co-nguy-co-nghi-het-mua-post1394782.html"
    ...
    print("Origin text: ", text)
    print("===================================================")
    print("Description: ", article.meta_description)
    print("===================================================")
    text = text_prossesing(text)
    print("text clean: ", text)
    print("===================================================")
    print("summarized:", summarize(text, ratio=0.2))
    print("===================================================")
    print("Keyword: ", get_keywords(article.text, ratio=0.5))'''
